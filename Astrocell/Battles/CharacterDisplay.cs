    ...
    public static class CharacterDisplay
    {
        public static GameObject Create(BattleCharacter character, string charImg, Vector2 location)
        {
            ...
            return Entity.Create(CharText("Background"), new Transform2 { Location = location, Size = new Size2(300, 400) })
                ...
                .Add(Entity.Create(CharText("Image"), new Transform2 { Location = location + new Vector2(30, 80), Size = new Size2(240, 240), ZIndex = 8 })
                .Add((o, r) => new Texture(r.LoadTexture(charImg, o)))
                .Add(Entity.Create(CharText("Hp Bar"), new Transform2 { Location = location + new Vector2(30, 30), Size = new Size2(240, 40), ZIndex = 9 })
                .Add((o, r) => new Texture(r.LoadTexture("Battle/hp-bar-back.png", o)))
                .Add(new TextDisplay { Text = () => $"{character.CurrentHp}/{character.MaxHp}" })
                .Add(Entity.Create(CharText("Hp Bar"), new Transform2 { Location = location + new Vector2(30, 30), Size = new Size2(240, 40), ZIndex = 10 })
                ...
                .Add(Entity.Create(CharText("Current Action Points"), new Transform2 { Location = location + new Vector2(40, 310), Size = new Size2(60, 60), ZIndex = 10 })
                .Add((o, r) => new Texture(r.LoadTexture("Battle/blue-icon.png", o)))
                .Add(new TextDisplay { Text = () => $"{character.CurrentActionPoints}AP" })
                .Add(Entity.Create(CharText("Current Energy"), new Transform2 { Location = location + new Vector2(215, 310), Size = new Size2(60, 60), ZIndex = 10 })
                .Add((o, r) => new Texture(r.LoadTexture("Battle/blue-icon.png", o)))
