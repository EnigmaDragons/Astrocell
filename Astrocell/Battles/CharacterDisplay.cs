...
namespace Astrocell.Battles
{
    public static class CharacterDisplay
    {
        public static List<GameObject> Create(BattleCharacter character, string charImg, Vector2 location)
        {
            ...
            var hpBarBack = Entity.Create(new Transform2 { Location = location + new Vector2(30, 30), Size = new Size2(240, 40), ZIndex = 9 })
                .Add((o, r) => new Texture(r.LoadTexture("Battle/hp-bar-back.png", o)))
                .Add(new TextDisplay { Text = () => $"{character.CurrentHp}/{character.MaxHp}" })
                .AttachTo(display);
            var hpBar = Entity.Create(new Transform2 { Location = location + new Vector2(30, 30), Size = new Size2(240, 40), ZIndex = 10 })
            ...
            var apIcon = Entity.Create(new Transform2 { Location = location + new Vector2(40, 310), Size = new Size2(60, 60), ZIndex = 10 })
                .Add((o, r) => new Texture(r.LoadTexture("Battle/blue-icon.png", o)))
                .Add(new TextDisplay { Text = () => $"{character.CurrentActionPoints}AP" })
                .AttachTo(display);

            var energyIcon = Entity.Create(new Transform2 { Location = location + new Vector2(215, 310), Size = new Size2(60, 60), ZIndex = 10 })
                .Add((o, r) => new Texture(r.LoadTexture("Battle/blue-icon.png", o)))
